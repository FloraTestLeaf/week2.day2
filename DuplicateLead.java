...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		...
		// TODO Auto-generated method stub
				...
				//duplicate lead
				WebElement dupli=driver.findElement(By.xpath("//a[text()='Duplicate Lead']"));
				dupli.click();
				
				//clear company name
				WebElement companyClear=driver.findElement(By.id("createLeadForm_companyName"));
				companyClear.clear();
				
				//enter company name
				companyClear.sendKeys("infosys");
				
				//clear first name
				WebElement firstNameLocalClear=driver.findElement(By.xpath("//input[@id='createLeadForm_firstName']"));
				firstNameLocalClear.clear();
				
				//first name
				firstNameLocalClear.sendKeys("Keziah");
				
				//click create
				WebElement createClick=driver.findElement(By.xpath("//input[@class='smallSubmit']"));
				createClick.click();
