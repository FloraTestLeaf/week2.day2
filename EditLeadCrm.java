...
public class EditLeadCrm {
	...
	public static void main(String[] args) {
		...
		//clear description
		WebElement descClear=driver.findElement(By.name("description"));
		descClear.clear();
		
		//important note
		WebElement imp=driver.findElement(By.id("updateLeadForm_importantNote"));
		imp.sendKeys("This is an important note that that always smile and trust Jesus in all situations");
